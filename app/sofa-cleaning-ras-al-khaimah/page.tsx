...
export const metadata: Metadata = {
  title: 'Sofa Cleaning Ras Al Khaimah | Sofa Deep Shampoo & Steam Cleaning',
  description: 'Al Haya Sofa Care — professional sofa deep shampoo & steam cleaning in Ras Al Khaimah (RAK). At-home doorstep service. Stain removal, leather care, pet hair removal. Same-day service. Call +971547199189.',
  keywords: [
...
export default function SofaCleaningRasAlKhaimah() {
  return (
    <>
        ...
        <section className="page-hero" style={{ minHeight: '60vh' }}>
          ...
          <div className="container-x" style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div className="city-hero-grid">
              <div>
            <div className="section-tag" style={{ marginBottom: 16 }}>Ras Al Khaimah Service</div>
            <h1 style={{ fontSize: 'clamp(34px, 5vw, 68px)', lineHeight: 1.0, marginBottom: 20, fontFamily: 'var(--font-display)', fontWeight: 900 }}>
              Sofa Cleaning <span style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: 400, color: 'var(--accent)' }}>Ras Al Khaimah</span>
            </h1>
            ...
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              ...
              <div className="city-hero-img">
                <img src="/sofa-cleaning-dubai-professional.webp" alt="Professional sofa cleaning service in Ras Al Khaimah by Al Haya Sofa Care" loading="eager" />
              </div>
            </div>
          </div>
        </section>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'start' }}>
              <div>
                ...
                <h2 style={{ fontSize: 'clamp(24px, 2.8vw, 40px)', marginBottom: 20, lineHeight: 1.15 }}>
                  Professional Sofa Cleaning <span style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', color: 'var(--accent)', fontWeight: 400 }}>in Ras Al Khaimah</span>
                </h2>
              ...
              <div>
                ...
                <h2 style={{ fontSize: 'clamp(22px, 2.5vw, 36px)', marginBottom: 20, lineHeight: 1.15 }}>
                  All Ras Al Khaimah <span style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', color: 'var(--accent)', fontWeight: 400 }}>Areas</span>
                </h2>
          ...
          <div className="container-x">
            <div style={{ textAlign: 'center', marginBottom: 40 }}>
              ...
              <h2 style={{ fontSize: 'clamp(24px, 3vw, 42px)', marginBottom: 12 }}>
                Our Sofa Cleaning Services in <span style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: 400, color: 'var(--accent)' }}>Ras Al Khaimah</span>
              </h2>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20 }}>
              {[
                { title: 'Sofa Deep Cleaning RAK', desc: 'Industrial extraction removes embedded dust, allergens and bacteria from every sofa type across Ras Al Khaimah.', color: 'var(--accent)' },
                { title: 'Sofa Shampooing RAK', desc: 'Professional foam shampoo treatment lifts deep grime and stains. Fast-dry formula — ready in 2–4 hours.', color: '#F59E0B' },
                { title: 'Pet Hair Removal RAK', desc: 'Specialist vacuum and roller treatment removes embedded pet hair from all cushions and seams.', color: '#D97706' },
                { title: 'Sofa Sanitization RAK', desc: 'Hospital-grade disinfection kills 99.9% of bacteria and germs. Safe for children and pets.', color: '#059669' },
              ].map((s) => (
          ...
          <div className="container-x">
            <div style={{ textAlign: 'center', padding: '48px 24px', background: 'var(--bg-elev)', borderRadius: 20, border: '1px solid var(--line-strong)' }}>
              <h2 style={{ fontSize: 'clamp(22px, 2.8vw, 38px)', marginBottom: 16 }}>
                Book Sofa Cleaning in <span style={{ color: 'var(--accent)' }}>Ras Al Khaimah</span>
              </h2>
