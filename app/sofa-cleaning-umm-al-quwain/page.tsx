...
const uaqSchema = {
  ...
  offers: [
    { '@type': 'Offer', name: 'Sofa Deep Cleaning Umm Al Quwain', price: '99', priceCurrency: 'AED' },
    { '@type': 'Offer', name: 'Sofa Shampooing Umm Al Quwain', price: '79', priceCurrency: 'AED' },
  ],
};
        ...
        <section className="page-hero" style={{ minHeight: '60vh' }}>
          ...
          <div className="container-x" style={{ position: 'relative', zIndex: 1 }}>
            <div className="breadcrumb">
              <Link href="/">Home</Link>
              <span>›</span>
              <span style={{ color: 'var(--fg-muted)' }}>Sofa Cleaning Umm Al Quwain</span>
            </div>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 32 }}>
              ...
              <a href="https://wa.me/971547199189?text=Hi%2C%20I%20need%20sofa%20cleaning%20in%20Umm%20Al%20Quwain." target="_blank" rel="noopener noreferrer" className="btn btn-wa" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <IconWhatsApp size={16} /> WhatsApp Us
              </a>
            </div>
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              {[{ n: 'AED 40', l: 'Starting Price' }, { n: 'Same Day', l: 'Service' }, { n: '12+ Areas', l: 'UAQ Coverage' }, { n: 'Certified', l: 'Team' }].map((s) => (
                <div key={s.l}>
