      ...
      <nav style={{
        ...
        <div style={{
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', flexShrink: 0 }}>
            <Image src="/al-haya-sofa-care-logo.webp" alt="Al Haya Sofa Care logo" width={40} height={40} priority style={{ borderRadius: 8, objectFit: 'cover', display: 'block' }} />
            <div>
      ...
      >
        ...
        <div style={{
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }} onClick={() => setOpen(false)}>
            <Image src="/al-haya-sofa-care-logo.webp" alt="Al Haya Sofa Care" width={36} height={36} style={{ borderRadius: 8, objectFit: 'cover' }} />
            <div>
